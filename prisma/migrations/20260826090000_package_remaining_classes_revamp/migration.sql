...
-- Remove UNLIMITED from the PostgreSQL enum.
...
-- Record the exact credit lot consumed by each new normal-class booking.
...
-- Keep legacy status labels useful without making them the source of truth.
UPDATE "Package"
SET "status" = 'EXPIRED'
