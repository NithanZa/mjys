...
const CLASS_DATA: Record<string, { name: string; description: string; tagline: string; intensity: "A" | "B" | "I"; isSpecial: boolean; durationMin: number }> = {
    tpl_easy_flow: { name: "Easy Flow", description: "A gentle and slow-paced flow focused on foundational postures, alignment, and simple transitions. Perfect for beginners and those seeking a mindful, relaxing practice.", tagline: "Find your flow, ease your mind.", intensity: "B", isSpecial: false, durationMin: 60 },
    tpl_morning_stretching: { name: "Morning Stretching", description: "Awaken your body with gentle stretches and movements that release tension built up during sleep. Great for flexibility and starting the day with energy.", tagline: "Awaken and energize.", intensity: "B", isSpecial: false, durationMin: 60 },
    tpl_open_shoulder: { name: "Open Shoulder", description: "Targeted stretches and strengthening postures to open up the shoulders, neck, and upper back, relieving tension from desk work and poor posture.", tagline: "Release tension, open your heart.", intensity: "A", isSpecial: false, durationMin: 60 },
    tpl_stretching: { name: "Stretching", description: "A full-body stretching session designed to improve overall flexibility, enhance range of motion, and promote deep relaxation of tight muscles.", tagline: "Lengthen and loosen.", intensity: "B", isSpecial: false, durationMin: 60 },
    tpl_hatha_flow: { name: "Hatha Flow", description: "A classic practice integrating breath with holding postures to build strength, balance, and mental clarity. Conducted at a steady, deliberate pace.", tagline: "Balance strength and stillness.", intensity: "A", isSpecial: false, durationMin: 60 },
    tpl_vinyasa: { name: "Vinyasa Flow", description: "A breath-paced flow that builds heat, strength, and a quiet mind. Suitable for steady beginners and confident regulars.", tagline: "Move with the breath.", intensity: "A", isSpecial: false, durationMin: 60 },
    tpl_strong_core: { name: "Strong Core", description: "A dynamic yoga session emphasizing core strength, stability, and abdominal power. Prepare to sweat and build deep core heat.", tagline: "Build strength from within.", intensity: "I", isSpecial: false, durationMin: 60 },
    tpl_office_syndrome: { name: "Office Syndrome", description: "Specially designed for office workers to target common problem areas: neck, shoulders, back, and hips. Alleviate chronic pain and stiffness.", tagline: "Relieve tension from desk work.", intensity: "A", isSpecial: false, durationMin: 60 },
    tpl_side_bend: { name: "Side Bend", description: "Focus on lateral stretches and spine elongation to expand lung capacity, open up the ribs, and improve side body flexibility.", tagline: "Stretch and expand your sides.", intensity: "A", isSpecial: false, durationMin: 60 },
    tpl_flexibility: { name: "Flexibility", description: "Focuses on deep stretches and passive holds to improve flexibility, release deep tissue tightness, and increase joint mobility.", tagline: "Unlock your body's flexibility.", intensity: "B", isSpecial: false, durationMin: 60 },
    tpl_backbending: { name: "Backbending", description: "Learn the anatomy and mechanics of safe backbends. Strengthen the spine, open the chest, and build flexibility in a controlled and safe environment.", tagline: "Open your front, strengthen your back.", intensity: "I", isSpecial: false, durationMin: 60 },
    tpl_hip_opening: { name: "Hip Opening", description: "A deep, nourishing practice focused entirely on opening the hips, releasing stored physical and emotional tension.", tagline: "Release tension in the hips.", intensity: "A", isSpecial: false, durationMin: 60 },
    tpl_balance_flow: { name: "Balance Flow", description: "A flowing sequence emphasizing both physical and mental balance. Connect with your center through steady standing poses and transitions.", tagline: "Find your steady center.", intensity: "A", isSpecial: false, durationMin: 60 },
    tpl_inversion_special: { name: "* Special Class * Inversion", description: "A 3-hour comprehensive workshop breaking down headstands, forearm stands, and handstands with step-by-step progressions, safety, and alignment.", tagline: "Invert your practice with safety.", intensity: "I", isSpecial: true, durationMin: 180 },
    tpl_gentle_flow: { name: "Gentle Flow", description: "A soft, nurturing yoga practice featuring gentle movements and breathing exercises to calm the nervous system and build gentle strength.", tagline: "Be kind to your body.", intensity: "B", isSpecial: false, durationMin: 60 },
    tpl_twist: { name: "Twist", description: "A detoxifying sequence of seated and standing twists designed to massage internal organs, improve digestion, and restore spinal mobility.", tagline: "Twist, detoxify, and restore.", intensity: "A", isSpecial: false, durationMin: 60 },
};
